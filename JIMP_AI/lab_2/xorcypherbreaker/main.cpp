...
int main(){
    std::vector<std::string> dictionary ={"the", "of", "and", "to", "a", "in", "is", "you", "are", "for", "that", "or", "it", "as", "be", "on",
    ...
    std::vector<char> crypt={93, 65, 76, 47, 7, 25, 15, 4, 76, 34, 0, 30, 30, 6, 31, 76, 12, 13, 2, 79, 24, 13, 4, 9, 76, 28, 15, 30, 10, 9,
    ...
    cout << XorCypherBreaker(crypt,3,dictionary);
    return 0;
}